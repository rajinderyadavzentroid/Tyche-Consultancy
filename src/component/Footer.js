      ...
      <Container>
        <div className="footer-grid">
          ...
          <div>
            ...
            <div className="footer-links">
              <a href="mailto:info@tychicorporatesolutions.com" className="footer-link">
                ...
                </svg>info@tychicorporatesolutions.com
              </a>
            </div>
          </div>
          <div>
            ...
            <div className="footer-social">
              <a href="https://www.linkedin.com/company/tyche-consultancy/" target="_blank" rel="noopener noreferrer" className="footer-link">
              ...
              <a href="https://www.instagram.com/tyche_consultancy?igsh=MXF0aXhtcDZ5MnR4ZQ==" target="_blank" rel="noopener noreferrer" className="footer-link">
